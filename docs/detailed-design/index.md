...
| 項目 | 内容 |
|---|---|
| 文書名 | SoraSense 詳細設計書 総則・索引 |
| システム名 | SoraSense |
| 文書版数 | 0.0.1 |
| 作成日 | 2026年8月13日 |
| 入力文書 | `docs/requirements.md` v0.0.0、`docs/basic-design.md` v0.2.0 |
| 文書目的 | 詳細設計文書群の共通前提、責務分担、参照関係および要件トレーサビリティを定義する |

### 1.1 変更履歴

| 版数 | 日付 | 変更内容 |
|---|---|---|
| 0.0.1 | 2026年8月14日 | 基本設計書の参照版数を更新 |
| 0.0.0 | 2026年8月13日 | 版数管理開始時点の詳細設計を登録 |
...
- 日時は内部・API・DBでUTCを使用し、利用者への表示時だけ指定タイムゾーンへ変換する。
...
| [infrastructure-operations.md](infrastructure-operations.md) | 配置、設定、ログ、監視、バックアップ | Proxy、証明書、Secret、ログ、復旧 |
...
| NFR-020～024 | `backend.md`、`ai-agent.md`、`ui-grafana.md`、`infrastructure-operations.md` |
