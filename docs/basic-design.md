...
| 文書版数 | 0.3.0 |
| 作成日 | 2026年8月11日 |
| 入力文書 | `docs/requirements.md` SoraSense 要件定義書 v0.1.0 |
| 下位文書 | `docs/detailed-design/index.md` SoraSense 詳細設計書 v0.1.0 |
...
| 版数 | 日付 | 変更内容 |
|---|---|---|
| 0.3.0 | 2026年8月21日 | 表示・集計タイムゾーンをAsia/Tokyoに固定 |
| 0.2.0 | 2026年8月14日 | APIドキュメント機能の公開方針を環境別設定へ変更 |
